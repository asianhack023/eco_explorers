   ...
   return (
      <nav className="navbar bg-transparent p-4 shadow-md">
         <div className="container mx-auto flex justify-between items-center">
            ...
            <ul
               className={`nav-menu md:flex md:space-x-6 text-white text-lg absolute md:relative top-0 left-0 w-full md:w-auto md:flex-row md:items-center transition-transform transform ${
                  isMenuOpen ? "translate-x-0" : "translate-x-full"
               } md:translate-x-0 bg-transparent  md:bg-transparent z-20`}
            >
               ...
               <li className="md:ml-4">
                  <Link
                     to="/"
                     className="hover:text-slate-50 block px-4 py-2 md:px-0"
                  >
                     Home
                  </Link>
               </li>
