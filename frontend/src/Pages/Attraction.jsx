...
// Import Navbar if it's in another file, or define it here
// import Navbar from './Navbar';

const Attractions = ({ noOfStars = 5 }) => {
    ...
    <>
      <div className="relative h-screen w-screen overflow-hidden">
        <div className="absolute top-0 left-0 w-full z-10 bg-blue-50">
          {/* Uncomment and define or import Navbar */}
          {/* <Navbar /> */}
        </div>
      ...
      <div className="attraction-b">
        <div className="w-full max-w-sm border border-gray-200 rounded-lg shadow bg-white">
          <a href="#">
            <img
          ...
          <div className="px-5 pb-5 bg-slate-300">
            ...
            <div className="flex items-center mt-1.3mb-5">
              ...
              <span className="bg-blue-100 text-blue-800 text-sm ml-6 font-semibold p-3 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">
                5.0
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                href="#"
                className="text-white bg-red-700 hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
              Explore More
              </a>
            </div>
